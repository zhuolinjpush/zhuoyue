				...
				<div class="col-md-8 col-md-offset-2">
					<div class="fh5co-hero-wrap">
						<div class="fh5co-hero-intro">
							<h1 class="to-animate hero-animate-1">所有的好产品</h1>
							<h2 class="to-animate hero-animate-2">详细介绍</h2>
							<p class="to-animate hero-animate-3"><a href="#" class="btn btn-outline btn-lg">需要快速跳转</a></p>
						</div>
					</div>
				</div>
			</div>		
