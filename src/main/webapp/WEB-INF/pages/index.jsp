...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<meta name="description" content="Zoyare main page" />
	<meta name="keywords" content="zoyare, template glass" />
	<meta name="author" content="Zoyare" />
			...
			<div class="container">
				<div class="row" id="fh5co-features">
					...
					<div class="col-md-4 col-sm-6 text-center fh5co-feature feature-box">
						...
						<h3 class="heading">自己填1,上面的图标可换</h3>
						<p>详细介绍1</p>
					</div>
					<div class="col-md-4 col-sm-6 text-center fh5co-feature feature-box"> 
						<div class="fh5co-feature-icon">
				...
				<div class="row" id="fh5co-works">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-section-heading work-box">
						<h2 class="fh5co-lead">大标题1</h2>
						<p class="fh5co-sub">详细说明</p>
					...
					<div class="col-md-4 col-md-offset-4 text-center work-box">
						<p><a href="#" class="btn btn-outline btn-md">View products这个可以进入产品界面</a></p>
					</div>
				</div>
				<!-- END row -->
	            ...
	            <h2 class="fh5co-uppercase-heading-sm text-center animate-box">我们的客户说了些什么。。。</h2>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-sm-6 footer-box">
						...
						<p>公司介绍 Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima delectus dolorem fugit totam, commodi ad.</p>
						<p><a href="#" class="btn btn-outline btn-sm">有没有需要发送邮件给我们</a></p>

					</div>
					<div class="col-md-4 col-sm-6 footer-box">
						<h3 class="fh5co-footer-heading">Links其他或友情链接</h3>
					...
					<div class="col-md-4 col-sm-12 footer-box">
						<h3 class="fh5co-footer-heading">Get in touch 放置其他联系方式</h3>
					...
					<div class="col-md-12 footer-box">
						...
						<p>&copy; 2016 Zoyare. All Rights Reserved. <br>可以放些其他的介绍，排版更好看 <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">链接</a> - Collect from 等等</p>
						</div>
					</div>
